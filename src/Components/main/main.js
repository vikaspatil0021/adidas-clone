    ...
    <div>
      ...
      <section className='d-flex flex-wrap justify-content-center'>
        <div className='section05'>
          ...
          <div className="fs-1 mb-4 fw-bolder mx-3">
          ...
          <div className='section05-grid'>
            ...
            <img class="high-res-picture___3SJ41 loaded___3ltPt img___zgj1u" id="tcm:209-761454" src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/enIN/Images/kids_1_tcm209-792188.png" decoding="async" loading="lazy" />
            </picture>
            <div className='fw-bold fs-5 m-2'>
                KIDS
              </div>
